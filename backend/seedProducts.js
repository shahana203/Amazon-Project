...
const products = [
  {
    ...
    priceCents: 1090,
    description:"High quality and popular product. Perfect for your daily needs and trusted by hundreds of satisfied customers.",
    category: "sports"
  },
  {
  ...
  },
  {
    ...
    priceCents: 1649,
   description:"High quality and popular product. Perfect for your daily needs and trusted by hundreds of satisfied customers.",category:"home-appliences",
  },
  {
...
async function seed() {
  try {
    ...
    await Product.deleteMany(); // Clear old data if needed
